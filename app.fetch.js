...
class SocketFetch extends ArcEventSource {
  ...
  _createFileBuffer() {
    ...
    if (body instanceof FormData ||
      ...
      return this._transferAndCreateFileBuffer(blobOptions);
    }
    return new Promise((resolve, reject) => {
  ...
  _transferAndCreateFileBuffer(blobOptions) {
    var body = this._request.body;
    return new Promise((resolve, reject) => {
      ...
      .then((addedBuffer) => {
        resolve(addedBuffer);
        // body = new Blob([new Uint8Array([13, 10]), addedBuffer], blobOptions);
        // var reader = new FileReader();
